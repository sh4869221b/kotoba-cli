...
passing receipts. Current exact-SHA receipts record 364 cases: translate 46,
commands 251, memory 22, files 45. Its standalone command is:
...
smoke run; `matrix` observes one common self-test and the 364-case matrix.
...
children, eight unit logs, two benchmarks, 30 measurements, 2,408 unit-test
executions, and four 364-case matrix receipts. Pull requests configure one
