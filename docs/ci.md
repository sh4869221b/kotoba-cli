...
The current exact-SHA local receipts record 281 executed CPU tests with one
separate skip and 282 deterministic tests with zero skips; both profiles record
...
passing receipts. Current exact-SHA receipts record 334 cases: translate 46,
commands 221, memory 22, files 45. Its standalone command is:
...
smoke run; `matrix` observes one common self-test and the 334-case matrix.
...
children, eight unit logs, two benchmarks, 30 measurements, 2,256 unit-test
executions, and four 334-case matrix receipts. Pull requests configure one
